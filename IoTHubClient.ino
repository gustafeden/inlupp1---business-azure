...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool alertStatus, String alertCode)
{
	...
	else
	{
		...
		Map_Add(properties, "alertMessage", alertStatus ? alertCode.c_str() : "none");
